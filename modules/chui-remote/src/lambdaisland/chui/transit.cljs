...
;; Update 2020-05-12: A new transit-cljs is out, but trying it out it does not
;; seem to be picking up the :default write handler, so still using this for the
;; time being.
